...
export function SuccessState({
  ...
  return (
    <Card className="p-8 sm:p-12 text-center border-2 border-green-200 bg-green-50">
      <div
        className="mx-auto h-14 w-14 rounded-full bg-green-100 text-green-600 grid place-items-center mb-4 animate-pulse"
        aria-hidden="true"
      >
      ...
      {action && (
        <div className="mt-6 flex gap-3 justify-center">
          <Button variant="default" size="sm" asChild={!action.onClick} onClick={action.onClick}>
