      ...
      <Card className="p-6">
        <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="smin">Salario mínimo</Label>
              <Input
                id="smin"
                type="number"
                value={salaryMin}
            ...
            <div>
              <Label htmlFor="smax">Salario máximo</Label>
              <Input
                id="smax"
                type="number"
                value={salaryMax}
          ...
          <p className="text-xs text-muted-foreground">
            La vacante se crea como borrador. Para publicarla, usa la vista de detalle.
          </p>
        </form>
      </Card>
    </div>
