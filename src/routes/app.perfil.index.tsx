...
function Perfil() {
  ...
  if (!profile)
    return (
      <div className="p-10 text-center text-muted-foreground">No se pudo cargar el perfil.</div>
    );
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <Card className="p-6 lg:p-8">
        <div className="flex flex-col md:flex-row gap-6">
          <div className="h-24 w-24 rounded-full bg-primary text-primary-foreground grid place-items-center text-2xl font-bold flex-none">
            {initials}
          </div>
