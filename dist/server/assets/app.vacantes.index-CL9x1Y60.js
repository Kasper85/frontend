...
import { l as listJobs } from "./jobs-CSfYomR6.js";
...
function Vacantes() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto space-y-4 sm:space-y-6", children: [
    ...
    loading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-full bg-muted grid place-items-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Search, { className: "h-6 w-6 text-muted-foreground" }) }),
      /* @__PURE__ */ jsx("p", { className: "font-semibold", children: "No se encontraron vacantes" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Intenta otros términos de búsqueda" })
    ] }) : /* @__PURE__ */ jsx("div", { className: "grid gap-3 sm:gap-4", children: filtered.map((job) => /* @__PURE__ */ jsx(JobCard, { job }, job.id)) })
  ] });
}
export {
