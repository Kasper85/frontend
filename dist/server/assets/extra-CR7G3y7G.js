const employability = {
  ...
  previousScore: 71,
  percentile: 82,
  // mejor que el 82% de candidatos similares
...
const edgeChallenges = [
  {
    ...
    status: "Disponible",
    description: "Debug un escenario único de comunicación entre contenedores en redes overlay personalizadas."
  },
  {
    id: "ch2",
...
const roiData = {
  ...
  qualityOfHire: { fyj: 8.7, industry: 6.4 },
  // /10
...
export {
  ...
  certCatalog as c,
  employability as e,
  learningMarketplace as l,
  matchExplanation as m,
  roiData as r,
  skillMap as s,
  zeroTrustRequirements as z
};
