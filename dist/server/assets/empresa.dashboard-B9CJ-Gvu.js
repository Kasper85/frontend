    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: active.slice(0, 3).map((v) => /* @__PURE__ */ jsx(Link, { to: "/empresa/vacantes/$id", params: {
            id: v.id
          }, className: "block", children: /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-[11px] text-muted-foreground font-mono", children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsx(UserCheck, { className: "h-3 w-3 text-primary" }),
                " ",
                v.shortlisted
              ] })
            ] }),
        ...
        /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: upcoming.map((i) => {
            const c = talentPool.find((t) => t.id === i.candidateId);
            return /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "h-9 w-9 rounded-md bg-primary/10 text-primary grid place-items-center font-mono text-[10px] flex-none", children: /* @__PURE__ */ jsxs("div", { className: "text-center leading-none", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-medium truncate", children: c.name }),
