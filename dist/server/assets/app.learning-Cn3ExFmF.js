...
import { l as learningPath } from "./router-BI82v7Nb.js";
...
function Learning() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-4 sm:space-y-6 px-4 sm:px-0", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { className: "p-4 sm:p-6", children: [
      ...
      /* @__PURE__ */ jsx(Progress, { value: overall, className: "h-2", "aria-label": `Progreso global: ${overall}%` })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-2 sm:space-y-3", children: learningPath.map((l) => {
      const Icon = typeIcon[l.type];
      return /* @__PURE__ */ jsxs(Card, { className: "p-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 hover:border-primary/40 transition-colors", role: "article", children: [
        ...
        /* @__PURE__ */ jsx(Button, { asChild: true, size: "sm", variant: l.progress > 0 ? "default" : "outline", className: "w-full sm:w-auto", children: /* @__PURE__ */ jsxs(Link, { to: l.type === "Evaluación" ? "/app/evaluaciones" : "/app/learning", className: "justify-center", children: [
