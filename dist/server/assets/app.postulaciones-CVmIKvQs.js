...
import { l as listMyApplications } from "./applications-l9aQRryv.js";
...
function Postulaciones() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto space-y-6", children: [
    ...
    loading ? /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: "Cargando postulaciones..." }) : apps.length === 0 ? /* @__PURE__ */ jsx(Card, { className: "p-10 text-center text-muted-foreground", children: /* @__PURE__ */ jsx("p", { children: "No has postulado a ninguna vacante todavía." }) }) : /* @__PURE__ */ jsx(Card, { className: "overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
