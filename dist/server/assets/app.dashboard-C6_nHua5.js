...
import { g as getRecommendations } from "./matching-CsV6TfgJ.js";
import { u as user, j as jobs, e as certifications, f as evalHistory, h as applications, l as learningPath } from "./router-xyFxSyDz.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: next.map((l) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 text-sm", children: [
            /* @__PURE__ */ jsx("div", { className: "h-8 w-8 rounded-md bg-primary/10 text-primary grid place-items-center flex-none", children: l.type === "Curso" ? /* @__PURE__ */ jsx(BookOpen, { className: "h-4 w-4" }) : l.type === "Evaluación" ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Award, { className: "h-4 w-4" }) }),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium truncate", children: l.title }),
        ...
        /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          ...
          /* @__PURE__ */ jsx("ul", { className: "mt-4 space-y-3 text-sm", children: applications.slice(0, 3).map((a) => /* @__PURE__ */ jsxs("li", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium truncate", children: a.jobTitle }),
              /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
                a.company,
                " · ",
                a.appliedAt
            ...
            /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "text-[10px] font-mono", children: a.status })
          ] }, a.id)) })
        ] }),
...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "p-5", children: [
    ...
    progress !== void 0 && /* @__PURE__ */ jsx(Progress, { value: progress, className: "h-1 mt-3" })
  ] });
}
export {
