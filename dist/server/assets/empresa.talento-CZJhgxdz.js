...
import { P as PageHeader, E as EmptyState } from "./EmptyState-CO4ipWYw.js";
...
function Talento() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-w-7xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[280px_1fr] gap-6", children: [
      /* @__PURE__ */ jsxs(Card, { className: "p-5 space-y-5 h-fit lg:sticky lg:top-20", children: [
        ...
        /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 text-xs cursor-pointer", children: [
          /* @__PURE__ */ jsx("input", { type: "checkbox", checked: onlyAvailable, onChange: (e) => setOnlyAvailable(e.target.checked), className: "rounded" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 min-w-0", children: [
        /* @__PURE__ */ jsxs(Card, { className: "p-4 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground hidden sm:block", children: "Ordenado por match IA" })
        ] }),
        filtered.length === 0 ? /* @__PURE__ */ jsx(EmptyState, { icon: UserSearch, title: "Sin resultados", description: "Ajusta los filtros o reduce el match mínimo para ver más candidatos." }) : /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: filtered.sort((a, b) => (b.match ?? 0) - (a.match ?? 0)).map((c) => /* @__PURE__ */ jsx(CandidateCard, { candidate: c }, c.id)) })
      ] })
    ] })
  ] });
}
