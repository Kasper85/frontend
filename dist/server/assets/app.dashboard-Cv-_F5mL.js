...
import { g as getRecommendations } from "./matching-BOgqsnTL.js";
import { u as user, j as jobs, e as certifications, f as evalHistory, h as applications, l as learningPath } from "./router-BI82v7Nb.js";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsx(PageHeader, { title: `Hola, ${user.name.split(" ")[0]}`, description: "Tu carrera tech en tiempo real, impulsada por inteligencia artificial." }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxs(Card, { className: "lg:col-span-2 p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Vacantes a tu medida" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Top 3 compatibles con tu perfil hoy" })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Tu Learning Path" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Personalizados por IA" })
            ] }),
            /* @__PURE__ */ jsx(Button, { asChild: true, variant: "ghost", size: "sm", children: /* @__PURE__ */ jsx(Link, { to: "/app/learning", children: "Ver todo" }) })
          ] }),
