      ...
      /* @__PURE__ */ jsxs(Card, { className: "lg:col-span-2 p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Candidatos Top 3 para entrevista" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Filtrados por match IA y verificación Zero Trust" })
          ] }),
